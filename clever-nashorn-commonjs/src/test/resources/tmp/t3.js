...
exports.printJS = function () {
    ...
    console.log("打印JS变量 | array {}", [1, 2.2, true, "nashorn", null, new Date(), function () { return 1 + 6; }]);
    console.log("打印JS变量 | object {}", {"string": "aaa", "number1": 12, "number2": 12.345, "boolean": true, "null": null, "date": new Date(), "function": function () { return 1 + 6; }});

...
* removed `logConsole` cap - creates too many problems - you can use [`core.log`](https://github.com/zloirock/core-js/#logConsole) module as that
...
* splitted [`logConsole` module](https://github.com/zloirock/core-js/#logConsole): `web.logConsole` - only cap for missing methods, `core.log` - bound methods & additional features
...
##### 0.3.3 - 2014.12.28
* [logConsole cap](https://github.com/zloirock/core-js/#logConsole) excluded from node.js default builds

##### 0.3.2 - 2014.12.25
* added cap for [ES5](https://github.com/zloirock/core-js/#ecmascript-5) freeze-family methods
* fixed `logConsole` bug
...
##### 0.2.5 - 2014.12.20
* `logConsole` no longer shortcut for `logConsole.log` (compatibility problems)
* some fixes
